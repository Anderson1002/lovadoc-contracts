...
-- Insertar estados para contratos usando solo los valores enum existentes
...
-- Agregar nuevo valor al enum para cancelado
ALTER TYPE contract_state ADD VALUE 'cancelado';
